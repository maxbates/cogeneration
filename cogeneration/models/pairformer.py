...
from cogeneration.models.triangular_attention import TriangleAttentionStartingNode, \
    TriangleAttentionEndingNode
from cogeneration.models.triangular_mult import TriangleMultiplicationOutgoing, \
