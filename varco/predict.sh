...
# single scaffold fine tune
# ckpt/varco/inpainting_20260112_073740/20260112_073740/last.ckpt
...
python varco/predict.py \
 ...
 interpolant.trans_coupler.noise_scale=0.1 \
 interpolant.trans_coupler.noise_end_t=0.85 \
 interpolant.rotation_coupler.noise_end_t=0.1 \
 ...
 interpolant.sampling.indel_sharpness=2.0 \
